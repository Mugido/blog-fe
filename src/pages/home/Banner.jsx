  ...
  return (
    ...
    >
      ...
      <div className="p-4 absolute bottom-0 left-0 z-20">
        ...
        Fuel Your Body: The Power of Balanced Nutrition for a Healthier You!
        </h2>
        <div className="flex mt-3">
          <img src="https://randomuser.me/api/portraits/women/45.jpg" className="h-10 w-10 rounded-full mr-2 object-cover" alt="Author" />
          <div>
            <p className="font-semibold text-gray-200 text-sm"> Nicole Melaina </p>
    ...
    >
      ...
      <div className="p-4 absolute bottom-0 left-0 z-20">
        ...
        <h2 className="text-3xl font-semibold text-gray-100 leading-tight">Breaking Boundaries: The Latest Scientific Discoveries Shaping Our Future</h2>
        <div className="flex mt-3">
